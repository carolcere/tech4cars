...
public class CarroServiceImpl implements CarroService{
    ...
    public CarroDTO atualizarAutomovel(String id, CarroDTO novoCarro) {
        Carro carroPersistencia = new ModelMapper().map(novoCarro, Carro.class);
        carroPersistencia.setId(id);
        carroPersistencia = repo.save(carroPersistencia);
        return new ModelMapper().map(carroPersistencia, CarroDTO.class);
    }
